...
import { DepartmentDialogComponent } from '../../../../../../main/webapp/app/entities/department/department-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Department Management Dialog Component', () => {
        let comp: DepartmentDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(DepartmentDialogComponent, '')
            .compileComponents();
        }));
